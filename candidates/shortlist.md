...
## July 2026 refresh — new candidates
...
window (older repos that only recently became active or finished) and raised the
per-query result cap, surfacing ~1,200 additional untracked Lean repos. Those
were deep-classified (clone, read, license + own-LOC + real-`sorry` count +
domain fit, with an adversarial pass for the large 2026 AI-slop tail);
556 new `include`/exclude decisions are recorded in
[`decisions.jsonl`](decisions.jsonl). Classification of the full backlog is
ongoing — the tables below are the import-worthy set found so far.

As before, the June/July additions relax the original staleness and Lean-≤v4.28
cutoffs (they are recent by nature); the actual toolchain and last-push date are
shown so a maintainer can judge porting effort. Criteria 1 (serious research- or
graduate-level math / CS / physics) and 2 (permissive, Apache-2.0-compatible
license) still gate inclusion. **Import-worthy** here means permissive license +
0 real `sorry` + ≥250 own LOC + no bespoke axioms.

### Import-ready picks (permissive, sorry-free, on or near the pool toolchain)

| Repo | Cat | Theorem / topic | License | Lean | LOC | Updated |
| --- | --- | --- | --- | --- | ---: | --- |
| [snisimu/leanjsontoyamlbyagent](https://github.com/snisimu/LeanJsonToYamlByAgent) | cslib | FIT2026 research artifact: proof-carrying JSON(RFC8259)->YAML converter. Frozen 7-contract spec + agent-generated core with 89 theorems… | MIT | v4.30.0 | 16,570 | 2026-06-29 |
| [nyxfoundation/gasper-lean4](https://github.com/NyxFoundation/gasper-lean4) | cslib | Serious Casper FFG/Gasper formalization (Nyx Foundation, Tokyo FV/MEV research org): accountable safety generalized to k-finalization +… | MIT | v4.31.0 | 11,948 | 2026-06-29 |
| [dmjdxb/lean-simon-theorem](https://github.com/dmjdxb/lean-simon-theorem) | cslib | Green's relations (R/L/J/H), syntactic monoid/congruence, and Simon's theorem (piecewise-testable <-> J-trivial syntactic monoid), both… | Apache-2.0 | v4.29.1 | 3,722 | 2026-06-13 |
| [leanprover/hex-matrix](https://github.com/leanprover/hex-matrix) | cslib | hex CAL: Mathlib-free dense-matrix library over arbitrary coeffs (arithmetic, elementary row/col ops, Gram matrix, submatrix), 39 lemmas… | Apache-2.0 | v4.32.0-rc1 | 1,943 | 2026-07-02 |
| [guanyangwang/ktv-swap-lean](https://github.com/guanyangwang/ktv-swap-lean) | mathlib | Formalizes 'Spectral Gap for the Binary Fixed-Margin Swap Chain': spectral-gap lower bounds for heat-bath/lazy-swap operators via… | MIT | v4.31.0 | 77,077 | 2026-06-22 |
| [karesansui-u/persistence-lean](https://github.com/karesansui-u/persistence-lean) | mathlib | Genuine sorry-free probability/functional-eq library under idiosyncratic 'Structural Persistence' framing: Cauchy exp, log_ratio_uniqueness… | MIT | v4.26.0 | 39,198 | 2026-07-01 |
| [inventor1975/vrcycle](https://github.com/inventor1975/VRCycle) | mathlib | Genuine 32k-LOC solo formalization (Vitaly Reznik, 14 Zenodo DOIs + preprints + blueprint): VR formal system proved equiv to first-order… | MIT | v4.29.1 | 32,387 | 2026-06-14 |
| [rkirov/jordan_pick](https://github.com/rkirov/jordan_pick) | mathlib | Sorry-free Pick's theorem (Freek #92), polygonal + continuous Jordan curve theorem (Maehara), and 2D Brouwer FPT from scratch; ~28.8k own… | Apache-2.0 | v4.32.0-rc1 | 28,791 | 2026-07-01 |
| [jingyuanli-hk/classical-lottery-in-action-lean-artifact](https://github.com/jingyuanli-hk/classical-lottery-in-action-lean-artifact) | mathlib | Formalization of Li-Tsetlin-Wang 'Classical Lottery in Action' (Mgmt Sci 2026, arXiv:2606.08902) + Wakker-Debreu-Koopmans additive… | Apache-2.0 | v4.28.0-rc1 | 22,517 | 2026-06-09 |
| [iharbury/zeromath](https://github.com/IharBury/ZeroMath) | mathlib | From-scratch (Mathlib-free) number foundations: Peano cardinal/ordinal naturals + integers, decimal reps, LessThan orders,… | Unlicense | stable | 10,570 | 2026-07-02 |
| [grandchallenge/mathcert](https://github.com/grandchallenge/MATHCERT) | mathlib | Frankl union-closed conjecture library: 198 real order-theory lemmas (SupIrred/IsAtom, lattice minimum-counterexample a la Bouchard,… | MIT | v4.29.1 | 7,221 | 2026-06-28 |
| [davorrunje/neural-network-proofs](https://github.com/davorrunje/neural-network-proofs) | mathlib | Sorry-free formalization of Cybenko & Leshno universal approximation theorems (universal_approximation, leshno_dense, univariate_density)… | Apache-2.0 | v4.32.0-rc1 | 6,094 | 2026-07-03 |
| [davorrunje/lean-playground](https://github.com/davorrunje/lean-playground) | mathlib | despite the name, 6k LOC formalizing Cybenko (1989) and Leshno (1993) universal approximation theorems plus Mikulincer-Reichman… | Apache-2.0 | v4.32.0-rc1 | 6,028 | 2026-06-26 |
| [frankienc/2dkakeyaconjecture](https://github.com/FrankieNC/2DKakeyaConjecture) | mathlib | Imperial MSc thesis (supervisor Bhavik Mehta): existence of a Besicovitch set in R^2, isKakeya.dimH_eq_one, exists_Gdelta_of_dimH,… | Apache-2.0 | v4.32.0-rc1 | 5,183 | 2026-07-02 |
| [hjvromen/lewis-common-knowledge-lean4](https://github.com/hjvromen/lewis-common-knowledge-lean4) | mathlib | Justification/epistemic-logic formalization of Lewis common knowledge (Vromen 2024): Cubitt-Sugden vs Sillari vs Vromen approaches, Fitting… | Apache-2.0 | v4.28.0 | 5,113 | 2026-06-27 |
| [catskillsresearch/scott1972](https://github.com/catskillsresearch/scott1972) | mathlib | Faithful formalization of Scott 1972 Continuous Lattices (LNM 274): ScottOpen/WayBelow, Prop 2.2, Thm 2.12 (injective T0 iff continuous… | Apache-2.0 | v4.30.0 | 4,401 | 2026-06-29 |
| [hjvromen/lewissillari](https://github.com/hjvromen/LewisSillari) | mathlib | Modal/Kripke-frame formalization of Sillari's reconstruction of Lewis's common-knowledge theorem: B3 failure + two repairs, S5… | Apache-2.0 | v4.28.0 | 4,390 | 2026-06-27 |
| [evanyyx-glitch/infotheorylean](https://github.com/Evanyyx-glitch/InfoTheoryLean) | mathlib | Real discrete info theory over Mathlib: Gibbs, Shannon entropy uniqueness (Shannon-Khinchin/Faddeev), Csiszar f-divergence… | Apache-2.0 | v4.30.0 | 3,580 | 2026-06-15 |
| [claytomode/johnson-lindenstrauss-lean](https://github.com/claytomode/johnson-lindenstrauss-lean) | mathlib | Genuine end-to-end Johnson-Lindenstrauss lemma (johnson_lindenstrauss_pointset) plus quantized-JL/QJL one-bit sign-sketch unbiasedness +… | Apache-2.0 | v4.31.0 | 2,099 | 2026-06-23 |
| [jancio/verifiedhandshake](https://github.com/jancio/VerifiedHandshake) | mathlib | Genuine game-theory formalization (Ondras, ICML 2026): verifiable-commitment wrapper makes (C,C) the unique Pareto-undominated Nash eq for… | MIT | v4.29.1 | 2,078 | 2026-06-26 |
| [chdarcy/markowitzformalization](https://github.com/chdarcy/MarkowitzFormalization) | mathlib | Markowitz mean-variance portfolio theory: frontier scalars A/B/C/D, frontierPortfolio optimality+uniqueness under PosDef covariance,… | Apache-2.0 | v4.31.0 | 2,016 | 2026-06-25 |
| [gaetanserre/leango](https://github.com/gaetanserre/LeanGO) | mathlib | Formalization of stochastic global-optimization algorithms (arXiv:2508.20671): Algorithm struct over Markov kernels/Ionescu-Tulcea,… | Apache-2.0 | v4.31.0-rc1 | 1,755 | 2026-06-25 |
| [enchonguyen/systemsandcontrol-lean4](https://github.com/enchonguyen/SystemsAndControl-Lean4) | mathlib | Control-theory formalization: discrete LTI state solution, asymptotic/Lyapunov stability equivalences (lim A^k=0, spectral radius<1, P -… | Apache-2.0 | v4.30.0-rc1 | 1,717 | 2026-06-30 |
| [gustafgithub/observer-equivariance-lean](https://github.com/gustafGitHub/observer-equivariance-lean) | mathlib | Group/category-theory classification: short exact sequence 1->G->AutBox_G(O/p)->Aut(S)->1 (strict_lift, rigidity, ker_Φ_eq_range_Λ) +… | Apache-2.0 | v4.31.0-rc1 | 1,448 | 2026-06-25 |
| [cycling-data-lab/od-lean](https://github.com/cycling-data-lab/od-lean) | mathlib | Genuine Mathlib probability/statistics: Cramer-Rao bound from Cauchy-Schwarz in inner-product spaces + ProbabilityTheory… | MIT | v4.31.0 | 997 | 2026-06-27 |
| [forgi86/control-theory-in-lean](https://github.com/forgi86/control-theory-in-lean) | mathlib | Lyapunov stability formalized after Khalil 2002: continuous-time, discrete-time (ε-δ with SublevelTrapped), and class-K comparison-function… | MIT | v4.31.0-rc1 | 573 | 2026-06-28 |
| [gustafgithub/limit-of-structure](https://github.com/gustafGitHub/limit-of-structure) | mathlib | Single-file paper formalization: Quotient Test as unique-factorization theorem (quotientTest, quotientTest_unique), fiber_blind,… | Apache-2.0 | v4.30.0 | 538 | 2026-06-13 |
| [cycling-data-lab/sbf-lean](https://github.com/cycling-data-lab/sbf-lean) | mathlib | Formalizes Theorem 1 (universal spectral lower bound) + Theorem 2 (ERM oracle) of Fosse-Pallares: transduction, Bessel… | MIT | v4.31.0 | 352 | 2026-06-27 |
| [karlesmarin/airy-bouncer-lean](https://github.com/karlesmarin/airy-bouncer-lean) | multi | First-in-any-ITP formalization of the Airy function + quantum-bouncer spectrum: airyFun_entire, airyFun_ode (y''=xy),… | Apache-2.0 | v4.30.0-rc2 | 1,087 | 2026-06-21 |

### More permissive import-worthy (need a version bump or have a noted import blocker)

| Repo | Cat | Theorem / topic | License | Lean | LOC | Updated |
| --- | --- | --- | --- | --- | ---: | --- |
| [elazarg/vegascore](https://github.com/elazarg/VegasCore) | cslib | Substantial CS/semantics lib: language for partial-info games (VegasCore ret/sample/commit/reveal), compiled to event graphs with WFProgram… | MIT | v4.30.0 | 71,209 | 2026-07-01 |
| [ethereum/cryptography-specs](https://github.com/ethereum/cryptography-specs) | cslib | Official Ethereum BLS12-381 + KZG crypto spec with Proofs/ dir: 73 theorems (field powNat_add/mul lemmas, reverseBits involution, KZG… | CC0-1.0 | v4.29.1 | 12,759 | 2026-07-03 |
| [katydid/paper-2027-mem-filter-lean](https://github.com/katydid/paper-2027-mem-filter-lean) | cslib | Katydid research paper artifact: memoized regex/grammar derivatives for fast filtering & schema validation; 299 lemmas over… | Apache-2.0 | v4.29.1 | 8,855 | 2026-07-01 |
| [chris-anto-froeschl/elligator](https://github.com/chris-anto-froeschl/elligator) | cslib | Genuine formalization of Bernstein-Hamburg-Krasnova-Lange 'Elligator' (Thms 1,3,4 + string encoding): Edwards curves, Legendre symbols,… | Apache-2.0 | v4.32.0-rc1 | 8,395 | 2026-06-27 |
| [diagonalean/diagonalean](https://github.com/DiagonaLean/DiagonaLean) | cslib | Computability/undecidability library on Cslib: Problem/ManyOneReduction/TuringReduction, halt_undecidable proven, PCP/MPCP/ambiguous-CFG… | Apache-2.0 | v4.32.0-rc1 | 6,626 | 2026-07-02 |
| [adventurelands/rsa-correctness-lean4](https://github.com/adventurelands/rsa-correctness-lean4) | cslib | RSA correctness from first principles, zero deps: binomial thm, freshman's dream, fermat_little, Bezout, crt_existence, capstone… | MIT | v4.29.0 | 2,574 | 2026-06-10 |
| [kim-em/hex-bareiss](https://github.com/kim-em/hex-bareiss) | cslib | Verified executable fraction-free Bareiss determinant over Int (Gaussian elim w/ exact division), part of hex computer-algebra library;… | Apache-2.0 | v4.32.0-rc1 | 1,860 | 2026-06-29 |
| [bergmannjg/lean4-parser-lemmas](https://github.com/bergmannjg/lean4-parser-lemmas) | cslib | Verified specs for fgdorais/lean4-parser combinators: termination via decrementsRemainingOnSuccess, respectsPosition_seqRight,… | MIT | v4.31.0 | 1,526 | 2026-06-27 |
| [davidturturean/erdos-870](https://github.com/davidturturean/erdos-870) | mathlib | Faithful, axiom-clean, sorry-free formalization of a negative answer to Erdos #870 (additive bases with many reps, no minimal subbasis);… | Apache-2.0 | v4.30.0-rc2 | 210,421 | 2026-06-26 |
| [edemaine/lean-wang](https://github.com/edemaine/lean-wang) | mathlib | Formalization of undecidability of Wang-tile plane tiling (Berger/Robinson via Ollinger-Robinson): compactness, machine-to-tile reductions,… | Apache-2.0 | v4.31.0 | 125,841 | 2026-07-01 |
| [catskillsresearch/scott1980](https://github.com/catskillsresearch/scott1980) | mathlib | Serious 62.7K-LOC formalization of Scott's PRG-19 domain theory (neighborhood systems, approximable maps, finitary projections, choice-free… | Apache-2.0 | v4.30.0 | 62,700 | 2026-06-29 |
| [cc-chen-tech/riemann-pnt-lean4](https://github.com/cc-chen-tech/riemann-pnt-lean4) | mathlib | Sorry-free, axiom-free analytic-NT library: real-part Dirichlet series for -zeta'/zeta, de la Vallee Poussin 3-4-1 inequality, compact… | Apache-2.0 | v4.29.1 | 26,080 | 2026-06-08 |
| [bksaiki/mpfx-lean](https://github.com/bksaiki/mpfx-lean) | mathlib | Mechanizes the appendix of the published paper 'When Double Rounding Is Correct' (Saiki-Zorn-Richey-Tatlock): abstract float format… | MIT | v4.29.0 | 18,747 | 2026-07-01 |
| [leanprover/hex-gram-schmidt](https://github.com/leanprover/hex-gram-schmidt) | mathlib | Executable fraction-free integer/rational Gram-Schmidt: leading Gram determinants (Bareiss), scaled coefficient matrix, lattice… | Apache-2.0 | v4.32.0-rc1 | 13,965 | 2026-07-02 |
| [kim-em/families-of-maps](https://github.com/kim-em/families-of-maps) | mathlib | Formalization of Lemma B.0.1 of Morrison-Walker 'The Blob Complex' Appendix B (topology: adapting families of maps to open covers),… | Apache-2.0 | v4.30.0 | 12,855 | 2026-07-02 |
| [m-ismail-za/ismailsprimitives](https://github.com/M-Ismail-ZA/IsmailsPrimitives) | mathlib | Despite vanity framing ('Ismail's Primitives', Zenodo-only paper, fresh 0-follower account), 12.7k LOC of genuine measure-theoretic… | MIT | v4.30.0 | 12,674 | 2026-07-01 |
| [brookww/leanstationaryharmonicmaps](https://github.com/BrookWW/LeanStationaryHarmonicMaps) | mathlib | Complete proof of the monotonicity formula for stationary W^{1,2}_loc harmonic maps (stationaryW12LocMonotonicity_euclidean):… | MIT | v4.30.0-rc2 | 12,492 | 2026-06-28 |
| [conquerv0/extrinsicgjmsoperators](https://github.com/conquerv0/ExtrinsicGJMSOperators) | mathlib | Serious conformal geometry by named authors (Yan, Xiao): GJMS/extrinsic GJMS operators, Fefferman-Graham ambient metric, Poincare-Einstein,… | Apache-2.0 | v4.26.0 | 10,990 | 2026-07-01 |
| [kim-em/hex-determinant](https://github.com/kim-em/hex-determinant) | mathlib | Mathlib-free executable Leibniz determinant + cofactor/adjugate/Cauchy-Binet/Plucker/Laplace/Gram/RowOps theory over hex-matrix; 116… | Apache-2.0 | v4.32.0-rc1 | 10,751 | 2026-06-29 |
| [craigxchen/jarnik](https://github.com/craigxchen/Jarnik) | mathlib | Substantive number theory: Gaussian-integer lattice points on circles, Mertens-type prime-interval sums, prime-descent dichotomy,… | Apache-2.0 | v4.30.0 | 8,936 | 2026-07-02 |
| [arij-aziz/5to9](https://github.com/Arij-Aziz/5to9) | mathlib | Real Selberg-sieve formalization (multi-prime Selberg upper bound cited to Iwaniec-Kowalski Thm 6.4/Ford, weight optimization, L2 bounds, a… | Apache-2.0 | v4.31.0 | 6,211 | 2026-06-28 |
| [leanprover/hex-gram-schmidt-mathlib](https://github.com/leanprover/hex-gram-schmidt-mathlib) | mathlib | Mathlib correspondence proofs for hex-gram-schmidt (integer RowAdd/Swap/Augmented, Gram determinant bridges to Mathlib gramSchmidt). 0… | Apache-2.0 | v4.32.0-rc1 | 5,887 | 2026-07-02 |
| [kitaken1/erdos176-nksqrtk-polynomial-bound-lean](https://github.com/KitaKen1/erdos176-nksqrtk-polynomial-bound-lean) | mathlib | Erdos Prob 176 N(k,sqrt k): Fejer-weighted poly upper bound; N176Sqrt=Nat.find, sqrtLargeSq k z:=k<=z^2; real analytic content, 0 sorry,… | Apache-2.0 | v4.31.0 | 5,508 | 2026-06-23 |
| [jesusvilela/connection_laplacian_lean](https://github.com/jesusvilela/connection_laplacian_lean) | mathlib | Spectral graph theory: Z/2 connection Laplacian on finite graphs; kernel-dimension theorem (Mobius vs flat),… | Apache-2.0 | v4.11.0 | 4,742 | 2026-07-02 |
| [leanprover/hex-lll-mathlib](https://github.com/leanprover/hex-lll-mathlib) | mathlib | Mathlib correspondence + short-vector theory for hex-lll; ~50 lemmas incl. headline lll_first_row_norm_sq_le_unconditional (LLL first-row… | Apache-2.0 | v4.32.0-rc1 | 4,567 | 2026-07-02 |
| [kim-em/hex-row-reduce](https://github.com/kim-em/hex-row-reduce) | mathlib | Verified executable Gauss-Jordan RREF over a field: rank, reduced echelon form, invertible transform, row-span (spanCoeffs_sound),… | Apache-2.0 | v4.32.0-rc1 | 4,376 | 2026-06-29 |
| [axiommath/erdos-public](https://github.com/AxiomMath/erdos-public) | mathlib | AxiomProver solutions to 7 Erdos problems: 209 disproof (Escudero arrangement, full Gallai-triangle defs), 403 (sum of factorials = 2^m),… | MIT | v4.27.0 | 3,815 | 2026-06-18 |
| [dkunert/cut-and-project](https://github.com/dkunert/cut-and-project) | mathlib | Period formulas for 1D cut-and-project gap sequences (rational-slope, ZMod residue-distribution Lemma 4.3) plus irrational aperiodicity… | MIT | v4.29.1 | 3,760 | 2026-06-27 |
| [kim-em/hex-determinant-mathlib](https://github.com/kim-em/hex-determinant-mathlib) | mathlib | Mathlib bridge identifying executable Leibniz det with Matrix.det (det_eq), plus Desnanot-Jacobi identity and principal-submatrix… | Apache-2.0 | v4.32.0-rc1 | 3,239 | 2026-06-29 |
| [kim-em/hex-bareiss-mathlib](https://github.com/kim-em/hex-bareiss-mathlib) | mathlib | Mathlib bridge (Kim Morrison hex project) proving row-pivoted Bareiss determinant = Mathlib.det = executable Leibniz det (bareiss_eq_det,… | Apache-2.0 | v4.32.0-rc1 | 1,750 | 2026-06-29 |
| [dkunert/three-gap-theorem-lean](https://github.com/dkunert/three-gap-theorem-lean) | mathlib | Three-gap (Steinhaus) theorem three_gap_card_le_three fully proved, uniform in rotation number a, via first-return/Slater route on… | MIT | v4.29.1 | 1,481 | 2026-06-25 |
| [gaetanserre/lipocons](https://github.com/gaetanserre/LipoCons) | mathlib | Formalizes Proposition 3 of Malherbe-Vayatis 2017 (theorem sample_iff_consistent) on global optimization of Lipschitz functions;… | MIT | v4.30.0 | 1,457 | 2026-06-25 |
| [dagurtomas/anabelianlib](https://github.com/dagurtomas/AnabelianLib) | mathlib | Reusable category-theory framework by Dagur Asgeirsson: profunctor composition/coYoneda extending mathlib's Profunctor API, chosen-coend… | Apache-2.0 | v4.32.0-rc1 | 1,396 | 2026-07-02 |
| [gotrevor/binomial-thresholds](https://github.com/gotrevor/binomial-thresholds) | mathlib | Erdos #684: constant-relaxed bounds on small prime factors of C(n,k). f_le_polylog (O((log n)^2)) and f_ge_log_frequently proven via… | Apache-2.0 | v4.31.0 | 1,335 | 2026-06-21 |
| [giulioruffini/ktait](https://github.com/giulioruffini/KTAIT) | mathlib | Kolmogorov Theory / algorithmic information theory: probabilistic Algorithmic Regulator Theorem, persistence conservation ledger,… | Apache-2.0 | v4.31.0 | 1,260 | 2026-06-28 |
| [antoinedufresne/bannai-bannai-stanton_theorem](https://github.com/AntoineduFresne/Bannai-Bannai-Stanton_Theorem) | mathlib | Sorry-free proof of bannai_bannai_stanton_bound: s-distance set S in R^d has /S/ <= choose(d+s,s), via Petrov-Pohoata / Croot-Lev-Pach;… | Apache-2.0 | v4.31.0 | 1,030 | 2026-06-26 |
| [leanprover/hex-matrix-mathlib](https://github.com/leanprover/hex-matrix-mathlib) | mathlib | Mathlib correspondence proofs for hex-matrix (9 theorems bridging hex Matrix to Mathlib Matrix/Vector/Gram). 'opaque' only appears in… | Apache-2.0 | v4.32.0-rc1 | 651 | 2026-07-02 |
| [eliottcassidy2000/lonely-runner](https://github.com/eliottcassidy2000/lonely-runner) | mathlib | Genuine Lonely Runner Conjecture formalization to mathlib conventions: proves conjecture_one/two (k=1,2), the q-witness lemma, dilation… | Unlicense | v4.30.0 | 537 | 2026-07-02 |
| [kim-em/hex-row-reduce-mathlib](https://github.com/kim-em/hex-row-reduce-mathlib) | mathlib | Mathlib bridge proving executable row reduction agrees with Matrix.rank/Submodule.span/LinearMap.ker: rank_eq, nullspace_span_eq_ker,… | Apache-2.0 | v4.32.0-rc1 | 291 | 2026-06-29 |
| [adambornemann-glitch/spectra](https://github.com/adambornemann-glitch/Spectra) | multi | 108K-LOC operator theory + QM: von Neumann extension theory, spectralTheorem (unique PVM, proved 2 ways), Stone, Kato-Rellich,… | MIT | v4.31.0-rc1 | 108,239 | 2026-07-03 |
| [bjoernkjoshanssen/ptyche](https://github.com/bjoernkjoshanssen/ptyche) | multi | Serious HP (hydrophobic-polar) protein-folding formalization: refutes Stecher's conjecture (non-monotonicity), proves objective bounds… | Apache-2.0 | v4.32.0-rc1 | 3,479 | 2026-06-25 |
| [danielhz/multiviewidentifiability](https://github.com/danielhz/MultiViewIdentifiability) | multi | DB query identifiability = determinacy (Nash-Segoufin-Vianu) + FD-closure certificates, plus a finite Shannon-entropy/Fano/KL-JS-divergence… | Apache-2.0 | v4.30.0 | 1,985 | 2026-06-28 |
| [deicyde/wikifunctions](https://github.com/Deicyde/wikifunctions) | multi | Verified Z-object composition-language evaluator + small Imp semantics + sorry-free Mathlib-oracle specs (coprime/gcd/totient/fib etc.) for… | Apache-2.0 | v4.32.0-rc1 | 1,671 | 2026-07-03 |

### Fit the criteria but unlicensed / copyleft (tracked, not import-ready)

Substantive and on-topic, but blocked by no explicit permissive license (or a
copyleft / CC-BY / GitHub `Other` classification). Worth a one-line issue asking
the author to add Apache-2.0 / MIT / BSD / ISC / 0BSD / Zlib if they want import.

| Repo | Cat | Theorem / topic | License | Lean | LOC | Updated |
| --- | --- | --- | --- | --- | ---: | --- |
| [duckki/graphql.lean](https://github.com/duckki/GraphQL.lean) | cslib | Formalization of GraphQL syntax+semantics: schema well-formedness, operation validation, bounded execution, data model, ground-type normal… | none | v4.29.1 | 117,599 | 2026-07-01 |
| [cajal-technologies/talos](https://github.com/cajal-technologies/talos) | cslib | Executable Wasm semantics + WP calculus in Lean: 358 theorems (factorial correctness, decoder/validate lemmas, lifting lemmas over… | AGPL-3.0-only | v4.31.0 | 45,596 | 2026-07-01 |
| [anoma/consistent-histories-lean](https://github.com/anoma/consistent-histories-lean) | cslib | Complete sorry-free formalization of Gabbay-Sheff 'Consistent histories' (double-spending safety): located semilattices with Cut, circuit… | CC-BY-4.0 | v4.28.0 | 39,750 | 2026-07-01 |
| [upbqdn/zebrafm](https://github.com/upbqdn/zebrafm) | cslib | Serious CS-software verification: 1952 kernel-checked theorems modeling Zcash Zebra consensus/protocol rules (hand-translated Rust->Lean… | none | v4.31.0 | 36,522 | 2026-06-26 |
| [arrow7000/fhm](https://github.com/Arrow7000/fhm) | cslib | Full Hindley-Milner Algorithm W: Infer.sound, Infer.principal, Infer.iff_typeable, unify_sound/complete, mutual+polymorphic recursion,… | none | v4.26.0 | 30,493 | 2026-07-01 |
| [lambdaclass/trust-lean](https://github.com/lambdaclass/trust-lean) | cslib | Verified codegen framework: ArithExpr/BoolExpr/ImpStmt DSLs to Core IR to C/Rust with CodeGenSound/compile_correct, MicroC/MicroRust… | none | v4.26.0 | 28,138 | 2026-06-10 |
| [basisresearch/veridns](https://github.com/BasisResearch/VeriDNS) | cslib | Verified DNS resolver proven against RFC 1034/1035/5452 specs elaborated from embedded RFC prose (include_rfc macro + NLP pipeline); 283… | none | v4.31.0-rc2 | 25,391 | 2026-06-11 |
| [fit-alessandro-berti/pm4lean](https://github.com/fit-alessandro-berti/pm4lean) | cslib | Large Petri-net/workflow-net formalization by PM4Py author: semantics, firing sequences, easy/relaxed/classical soundness, proper… | GPL-3.0 | v4.29.1 | 22,623 | 2026-06-30 |
| [fradamt/verified-consensus](https://github.com/fradamt/verified-consensus) | cslib | Decoupled Consensus (fradamt): mathlib formalization of BFT accountable-safety (n=3f+1, MainSafety/AccountableSafety, fork-choice-store… | none | v4.30.0-rc2 | 11,033 | 2026-06-30 |
| [digama0/domain-semantics-lean](https://github.com/digama0/domain-semantics-lean) | cslib | Mario Carneiro: denotational semantics of a dependently-typed lambda-calculus (MLTT) with soundness, adequacy, Pi- and sort-injectivity… | none | v4.29.0 | 10,877 | 2026-07-03 |
| [albertluo27/irrationality](https://github.com/albertluo27/irrationality) | mathlib | Real number theory: rational_iff_eventuallyAP for floor-sum divisibility sets A_r, CF-denominator rigidity (oddCFDenoms_rigid_on_Icc),… | none | v4.30.0 | 66,301 | 2026-06-28 |
| [kitaken1/finite-simple-groups-lean](https://github.com/KitaKen1/finite-simple-groups-lean) | mathlib | Mathieu M11/M12/M22 + PSL(3,4): orders & simplicity via kernel-checked decide certs (Witt designs S(4,5,11)/S(5,6,12)/S(3,6,22), stabilizer… | none | v4.30.0 | 34,694 | 2026-06-10 |
| [adas1236/sphereobstructionhilbertshiftquotient](https://github.com/adas1236/SphereObstructionHilbertShiftQuotient) | mathlib | Research result by Rosendal & Das (blueprint authors): shiftSphereQuotient S(l2(Z))/<bilateral shift> has infinite Hilbert distortion… | none | v4.30.0 | 15,791 | 2026-06-30 |
| [chen1088/dict_lean](https://github.com/chen1088/dict_lean) | mathlib | Research formalization of a dictatorship-testing paper on S_n: Boolean-cube/FKN/Fourier lemmas, Specht dimension certificates (Lem… | none | v4.32.0-rc1 | 12,258 | 2026-07-01 |
| [fradamt/fast-confirmation](https://github.com/fradamt/fast-confirmation) | mathlib | Ethereum Fast Confirmation Rule (arXiv:2405.00549) formalized by paper co-author fradamt (F. D'Amato, EF consensus researcher): 10.4k LOC,… | none | v4.30.0-rc2 | 10,387 | 2026-07-02 |
| [axiommath/rogersramanujan](https://github.com/AxiomMath/RogersRamanujan) | mathlib | Both Rogers-Ramanujan identities fully proved via Bailey pairs + Jacobi triple product over nonarchimedean rings; plus pentagonal number… | none | v4.31.0 | 9,859 | 2026-07-01 |
| [axiommath/axiomlib](https://github.com/AxiomMath/axiomlib) | multi | AxiomMath's curated staging library, mathlib-style: q-theory (qPochhammer, q-hypergeometric), Tate's algorithm steps for elliptic curves,… | none | v4.31.0 | 20,725 | 2026-07-01 |
| [itakura-hidetoshi/4d-mass-gap](https://github.com/itakura-hidetoshi/4d-mass-gap) | physlean | Massive conditional Yang-Mills mass-gap formalization: real finite Wilson/Dobrushin/Gibbs spectral-gap math (heat-bath Poincare, Rayleigh… | CC-BY-4.0 | v4.30.0-rc2 | 232,930 | 2026-07-03 |
| [hxrts/stat-mech](https://github.com/hxrts/stat-mech) | physlean | Substantial genuine stat-mech corpus: Hamiltonian mechanics (convex energy, Legendre duality, Lyapunov), mean-field ODE existence via… | none | v4.26.0 | 26,800 | 2026-06-28 |
